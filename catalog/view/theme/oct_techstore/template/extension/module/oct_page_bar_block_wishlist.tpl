<div class="row oct-carousel-row">
	<div class="col-sm-12">
		<div class="oct-carousel-box">
			<div class="oct-carousel-header"><a href="<?php echo $wishlist; ?>"><?php echo $text_wishlist; ?></a></div>
			<div id="oct-favorite-carousel" class="owl-carousel owl-theme">
				...
				<div class="item">
				  <div class="image">
				    ...
				    <?php } else { ?>
				      <div class="quick-view"><a href="<?php echo $product['href']; ?>"><?php echo $button_popup_view; ?></a></div>
				    <?php } ?>   
                ...
                <?php } ?>
				  ...
				  <div class="cart">
				    ...
				    <?php } ?>
				    <a onclick="remove_wishlist('<?php echo $product['product_id']; ?>');" title="<?php echo $remove_wishlist; ?>" class="wishlist oct-button"><i class="fa fa-trash" aria-hidden="true"></i></a>
...
<script>
$('#oct-favorite-carousel').owlCarousel({
  items: 4,
  itemsDesktop : [1599,4],
  itemsDesktop : [1199,4],
