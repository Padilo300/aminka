      ...
      <div class="form-horizontal">
        ...
        <div class="form-group required">
          ...
          <div class="input-group">
            ...
            <span class="input-group-btn"><button type="button" id="button-quote" data-loading-text="<?php echo $text_loading; ?>" class="oct-button"><?php echo $button_quote; ?></button></span>
	          </div>
          </div>
        </div>
