...
class ControllerExtensionModuleOctLatest extends Controller {
    public function index($setting) {
        ...
        $this->load->language('extension/module/oct_latest');
        ...
        if ($results) {
            ...
            if ($data['products']) {
                return $this->load->view('extension/module/oct_latest', $data);
            }
        }
    }
}