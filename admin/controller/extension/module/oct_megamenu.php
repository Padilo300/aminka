...
class ControllerExtensionModuleOctMegamenu extends Controller {
    ...
    public function add() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
            ...
            $this->response->redirect($this->url->link('extension/module/oct_megamenu', 'token=' . $this->session->data['token'] . $url, true));
        }
    ...
    protected function getList() {
        ...
        $data['breadcrumbs'][] = array(
            ...
            'href' => $this->url->link('extension/module/oct_megamenu', 'token=' . $this->session->data['token'] . $url, true)
        );
        
        $data['action'] = $this->url->link('extension/module/oct_megamenu', 'token=' . $this->session->data['token'], true);
        $data['add']    = $this->url->link('extension/module/oct_megamenu/add', 'token=' . $this->session->data['token'] . $url, true);
        $data['delete'] = $this->url->link('extension/module/oct_megamenu/delete', 'token=' . $this->session->data['token'] . $url, true);
        ...
        foreach ($results as $result) {
            $data['oct_megamenus'][] = array(
                ...
                'edit' => $this->url->link('extension/module/oct_megamenu/edit', 'token=' . $this->session->data['token'] . '&megamenu_id=' . $result['megamenu_id'] . $url, true)
            );
        }
        ...
        $data['sort_title']      = $this->url->link('extension/module/oct_megamenu', 'token=' . $this->session->data['token'] . '&sort=otmmd.title' . $url, true);
        $data['sort_link']       = $this->url->link('extension/module/oct_megamenu', 'token=' . $this->session->data['token'] . '&sort=otmm.link' . $url, true);
        $data['sort_sort_order'] = $this->url->link('extension/module/oct_megamenu', 'token=' . $this->session->data['token'] . '&sort=otmm.sort_order' . $url, true);
        ...
        $pagination->url   = $this->url->link('extension/module/oct_megamenu', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
        ...
        $this->response->setOutput($this->load->view('extension/module/oct_megamenu.tpl', $data));
    }
    ...
    protected function getForm() {
        ...
        if (isset($this->request->get['megamenu_id'])) {
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('extension/module/oct_megamenu/edit', 'token=' . $this->session->data['token'] . '&megamenu_id=' . $this->request->get['megamenu_id'] . $url, true)
            );
        }
        
        if (!isset($this->request->get['megamenu_id'])) {
            $data['action'] = $this->url->link('extension/module/oct_megamenu/add', 'token=' . $this->session->data['token'] . $url, true);
        } else {
            $data['action'] = $this->url->link('extension/module/oct_megamenu/edit', 'token=' . $this->session->data['token'] . '&megamenu_id=' . $this->request->get['megamenu_id'] . $url, true);
        }
        
        $data['cancel'] = $this->url->link('extension/module/oct_megamenu', 'token=' . $this->session->data['token'] . $url, true);
        ...
        if (isset($this->request->post['store'])) {
            ...
            $data['menu_stores'] = $this->model_extension_module_oct_megamenu->getMegamenuStores($this->request->get['megamenu_id']);
        } else {
            $data['menu_stores'] = array(
                0
            );
        }
        ...
        if (isset($this->request->post['customer_group'])) {
            ...
            $data['menu_customer_groups'] = array(
                0
            );
        }
        ...
        $categories = $this->model_extension_module_oct_megamenu->getCategories();
        ...
        $data['manufacturers'] = $this->model_extension_module_oct_megamenu->getManufacturers(array(
            'sort' => 'name',
            'order' => 'ASC'
        ));
        ...
        $data['informations'] = $this->model_extension_module_oct_megamenu->getInformations(array(
            'sort' => 'id.title',
            'order' => 'ASC'
        ));
        ...
        $this->response->setOutput($this->load->view('extension/module/oct_megamenu_form.tpl', $data));
    }
