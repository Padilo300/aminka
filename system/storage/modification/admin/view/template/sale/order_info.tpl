    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <?php if (isset($oct_advanced_options_settings_data['status']) && $oct_advanced_options_settings_data['status']) { ?>
          ...
          <?php if ($option['type'] == 'oct_quantity' && $oct_advanced_options_settings_data['quantity_status'] && isset($option['oct_quantity_value']) && $option['oct_quantity_value']) { ?>
            x<?php echo $option['oct_quantity_value']; ?>
          <?php } ?>
          <?php if (($oct_advanced_options_settings_data['allow_sku'] && $option['sku']) || ($oct_advanced_options_settings_data['allow_model'] && $option['model'])) { ?>(<?php if ($oct_advanced_options_settings_data['allow_sku'] && $option['sku']) { ?><?php echo $text_oct_option_sku; ?>: <?php echo $option['sku']; ?>, <?php } ?><?php if ($oct_advanced_options_settings_data['allow_model'] && $option['model']) { ?><?php echo $text_oct_option_model; ?>: <?php echo $option['model']; ?><?php } ?>)
          <?php } ?>
          </small>
        <?php } else { ?>
