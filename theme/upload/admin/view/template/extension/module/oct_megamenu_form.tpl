        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" class="form-horizontal">
          ...
          <div class="tab-content">
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div class="checkbox">
                      <label>
                        <?php if (in_array($store['store_id'], $menu_stores)) { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <div class="well well-sm" style="height: 150px; overflow: auto;">
                    ...
                    <div class="checkbox">
                      <label>
                      	<?php if (in_array(0, $menu_customer_groups)) { ?>
              ...
              <div id="additional_setting_block">
                <div class="form-group">
                ...
                <div class="form-group for-category-only">
                  ...
                  <div class="col-sm-10">
                    <select name="display_type" class="form-control">
                      ...
                      <option value="3" <?php echo $display_type == 3 ? 'selected="selected"' : ''; ?> class="for-category-only"><?php echo $text_display_type_3; ?></option>
                    </select>
                  </div>
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-language">
              ...
              <div class="tab-content">
                ...
                <div class="form-group required">
                  ...
                  <div class="form-group for-product-only">
...
<script type="text/javascript"><!--
  $('select[name=item_type]').change(function() {
    ...
    if (val == 1) {
      ...
      $('#oct_megamenu_descr').hide();
      $('[name=info_text]').parent().parent().hide();
      $('.for-product-only').hide();
      ...
      $('#oct_megamenu_descr').hide();
      $('[name=info_text]').parent().parent().show();
      $('.for-product-only').show();
