...
<div class="row oct-carousel-row">
  <div class="col-sm-12">
    <div class="oct-carousel-box">
      ...
      <div id="owl-carousel-module-viewed-<?php echo $module; ?>" class="owl-carousel owl-theme">
...
<?php if (isset($oct_lazyload) && $oct_lazyload) { ?>
	setTimeout(function() {
		$("#owl-carousel-module-viewed-<?php echo $module; ?> img.lazy-module").lazyload({
			effect : "fadeIn"
		});
	}, 1200);
	<?php } ?>

  $('#owl-carousel-module-viewed-<?php echo $module; ?>').owlCarousel({
