...
<?php } ?>
  <div class="col-sm-12">
    <div class="oct-carousel-box">
      ...
      <div id="oct-products-from-category-<?php echo $module; ?>" class="owl-carousel owl-theme">
...
$(function() {
	<?php if (isset($oct_lazyload) && $oct_lazyload) { ?>
	setTimeout(function() {
		$("#oct-products-from-category-<?php echo $module; ?> img.lazy-module").lazyload({
			effect : "fadeIn"
		});
	}, 1200);
	<?php } ?>
	
	$('#oct-products-from-category-<?php echo $module; ?>').owlCarousel({
